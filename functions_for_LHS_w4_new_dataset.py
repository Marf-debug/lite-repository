...
def dataframe_2_qgrid(df):
    ...
    # Extra columns used in newer cohorts / derived risk features
    column_definitions.update({
        'admissions_2024': { 'toolTip': "Number of admissions to the hospital during 2024" },
        'visits_b2025': { 'toolTip': "Number of appointments before 01/01/2025" },
        'ed_presentations_next_year': { 'toolTip': "Number of emergency department presentations in the next year" },
        'any_ed_next_year': { 'toolTip': "Whether the person had any ED presentation in the next year" },
        'comorb_count': { 'toolTip': "Count of comorbidities" },
        'comorb_ge4': { 'toolTip': "Whether comorbidity count is >= 4" },
        'polypharm_cv_n': { 'toolTip': "Number of cardiovascular-related medications (polypharmacy count)" },
        'polypharm_cv_ge3': { 'toolTip': "Whether cardiovascular polypharmacy count is >= 3" },
        'on_insulin': { 'toolTip': "Whether the person is on insulin" },
        'hba1c_gt9': { 'toolTip': "Whether HbA1c is > 9" },
        'egfr_lt45': { 'toolTip': "Whether eGFR is < 45" },
        'highrisk_glyco_renal': { 'toolTip': "High-risk glycaemic/renal flag (derived)" },
        'glyco_renal_highrisk': { 'toolTip': "High-risk glycaemic/renal flag (derived)" },
        'insulin_plus3cv': { 'toolTip': "Whether the person is on insulin and >=3 cardiovascular medications" },
        'acr': { 'toolTip': "Albumin-creatinine ratio (ACR)" },
        'risk_hba1c': { 'toolTip': "Risk component derived from HbA1c" },
        'risk_egfr': { 'toolTip': "Risk component derived from eGFR" },
        'risk_acr': { 'toolTip': "Risk component derived from ACR" },
        'risk_bp': { 'toolTip': "Risk component derived from blood pressure" },
        'risk_potassium': { 'toolTip': "Risk component derived from potassium" },
        'risk_prior_adm': { 'toolTip': "Risk component derived from prior admissions" },
        'risk_foot_ulcer': { 'toolTip': "Risk component derived from foot ulcer status" },
        'risk_cardiac': { 'toolTip': "Risk component derived from cardiac conditions" },
        'risk_duration': { 'toolTip': "Risk component derived from duration of diabetes" },
        'risk_age': { 'toolTip': "Risk component derived from age" },
        'risk_bmi': { 'toolTip': "Risk component derived from BMI" },
        'risk_score_2025': { 'toolTip': "Composite risk score for 2025" },
        'prob_hosp_2025': { 'toolTip': "Predicted probability of hospitalisation in 2025" },
        'label': { 'toolTip': "Outcome/label used for modelling" },
        'diabetes_group': { 'toolTip': "Diabetes subgroup/category" },
        'risk_ulcer': { 'toolTip': "Risk indicator related to ulceration" },
        'risk_instability': { 'toolTip': "Risk indicator related to clinical instability" },
        'patient_id': { 'toolTip': "Patient identifier (alternate primary key)" }
    })
...
# Added columns for newer cohort versions / derived risk features
col_name_2_discription.update({
    'admissions_2024': "Number of admissions to the hospital during 2024",
    'visits_b2025': "Number of appointments before 01/01/2025",
    'ed_presentations_next_year': "Number of emergency department presentations in the next year",
    'any_ed_next_year': "Whether the person had any ED presentation in the next year",
    'comorb_count': "Count of comorbidities",
    'comorb_ge4': "Whether comorbidity count is >= 4",
    'polypharm_cv_n': "Number of cardiovascular-related medications (polypharmacy count)",
    'polypharm_cv_ge3': "Whether cardiovascular polypharmacy count is >= 3",
    'on_insulin': "Whether the person is on insulin",
    'hba1c_gt9': "Whether HbA1c is > 9",
    'egfr_lt45': "Whether eGFR is < 45",
    'highrisk_glyco_renal': "High-risk glycaemic/renal flag (derived)",
    'glyco_renal_highrisk': "High-risk glycaemic/renal flag (derived)",
    'insulin_plus3cv': "Whether the person is on insulin and >=3 cardiovascular medications",
    'acr': "Albumin-creatinine ratio (ACR)",
    'risk_hba1c': "Risk component derived from HbA1c",
    'risk_egfr': "Risk component derived from eGFR",
    'risk_acr': "Risk component derived from ACR",
    'risk_bp': "Risk component derived from blood pressure",
    'risk_potassium': "Risk component derived from potassium",
    'risk_prior_adm': "Risk component derived from prior admissions",
    'risk_foot_ulcer': "Risk component derived from foot ulcer status",
    'risk_cardiac': "Risk component derived from cardiac conditions",
    'risk_duration': "Risk component derived from duration of diabetes",
    'risk_age': "Risk component derived from age",
    'risk_bmi': "Risk component derived from BMI",
    'risk_score_2025': "Composite risk score for 2025",
    'prob_hosp_2025': "Predicted probability of hospitalisation in 2025",
    'label': "Outcome/label used for modelling",
    'diabetes_group': "Diabetes subgroup/category",
    'risk_ulcer': "Risk indicator related to ulceration",
    'risk_instability': "Risk indicator related to clinical instability",
    'patient_id': "Patient identifier (alternate primary key)"
})
...
def _dtype_to_vartype(dtype) -> str:
    """Map a pandas dtype to a coarse feature type for display."""
    s = str(dtype)
    if s in pyttype_2_vartype:
        return pyttype_2_vartype[s]
    if s.startswith(('int', 'uint', 'float')):
        return 'Numerical'
    if 'datetime' in s:
        return 'Numerical'
    return 'Categorical'
...
def features_description(dataframe, category):
    ...
    for feature in dataframe.columns:
        ...
        feature_type.append(_dtype_to_vartype(dataframe[feature].dtypes))
